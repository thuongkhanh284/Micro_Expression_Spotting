...
def main():
    ...
    parameters = process_parser(parser)
    
    print(' ....Completed ')
    return 0

def process_parser(parser):
    parser.add_argument("-file", help = 'give full path of input file name')
    parser.add_argument("-webcam", help = 'give input folder name')
    
    
    args = parser.parse_args()
    if (args.file == None):
        args.file = 'CASME2.mp4'
